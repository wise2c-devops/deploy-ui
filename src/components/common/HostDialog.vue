  ...
  <el-dialog title="主机" :visible="dialogVisible" size="tiny" :close-on-click-modal="false" :show-close="false">
    <form>
      <div class="form-group">
        ...
        <input type="text" class="form-control" v-model="host.hostname" id="hostName" placeholder="主机名称">
      </div>
      <div class="form-group">
        <label for="ip">主机 IP</label>
        <input type="text" class="form-control" v-model="host.ip" id="ip" placeholder="10.0.0.2">
      </div>
      <div class="form-group">
