<template>
  <el-dialog :title="$t('components.componentModal.modalTile')" :visible="dialogVisible" size="small" :close-on-click-modal="false" :show-close="false">
    <form @submit.prevent="onSubmit">
      <div class="form-group">
        <label for="componentType " class="required">{{$t('components.componentModal.componentType')}}</label>
        <br>
      ...
      <div class="form-group">
        <label for="componentType " class="required">{{$t('components.componentModal.version')}}</label>
        <br>
  ...
  methods: {
    ...
    validateTips(property) {
      if (property.type==='host') {
        return this.$t('components.componentModal.hostTips')
      }else {
        return this.$t('components.componentModal.tips') +`${property.label}`
      }
    },
    callMethod() {
