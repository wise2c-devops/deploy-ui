...
import { cancel, getCluster, fetchClusterDetail, getClusterStatus, fetchClusterStatus } from '../vuex/modules/cluster'
  ...
  data() {
    return {
      ...
      stages: [
        ...
        { name: 'Docker', icon: 'wise-icon-docker-three', value: 'docker', enabled: false, sort: 2 },
        { name: 'Harbor', icon: 'wise-icon-harbor', value: 'harbor', enabled: false, sort: 3 },
        { name: 'LoadBalancer', icon: 'wise-icon-lb-service', value: 'loadbalancer', enabled: false, sort: 4 },
        { name: 'Etcd', icon: 'wise-icon-etcd', value: 'etcd', enabled: false, sort: 5 },
        ...
        { name: 'Mysql', icon: 'wise-icon-mysql', value: 'mysql', enabled: false, sort: 8 },
        { name: 'Redis', icon: 'wise-icon-redis', value: 'redis', enabled: false, sort: 9 },
        { name: 'Consul', icon: 'wise-icon-consul', value: 'consul', enabled: false, sort: 10 },
        { name: 'Rabbitmq', icon: 'wise-icon-rabbitmq', value: 'rabbitmq', enabled: false, sort: 11 },
        { name: 'Nats', icon: 'wise-icon-sys-operating--evn', value: 'nats', enabled: false, sort: 12 },
        { name: 'Wisecloud', icon: 'wise-icon-wisecloud', value: 'wisecloud', enabled: false, sort: 13 },
        { name: 'Helm', icon: 'wise-icon-helm', value: 'helm', enabled: false, sort: 14 },
        { name: 'Contour', icon: 'wise-icon-contour', value: 'contour', enabled: false, sort: 15 },
        { name: 'Istio', icon: 'wise-icon-istio', value: 'istio', enabled: false, sort: 16 },
        { name: 'Jaeger', icon: 'wise-icon-jaeger', value: 'jaeger', enabled: false, sort: 17 },
        { name: 'Kong', icon: 'wise-icon-kong', value: 'kong', enabled: false, sort: 18 },
        { name: 'Ambassador', icon: 'wise-icon-ambassador', value: 'ambassador', enabled: false, sort: 19 },
        { name: 'ElasticCloud', icon: 'wise-icon-elasticcloud', value: 'elasticcloud', enabled: false, sort: 20 }
      ]
    }
  },
  methods: {
